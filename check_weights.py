...
supervised_model = YOLO("runs/detect/train4/weights/best.pt")
...
fine_tuning_model = YOLO("runs/detect/train5/weights/best.pt")
# SSL model
ssl_model = YOLO("yolov8n.yaml")
ssl_weights = torch.load('./output/ssl_train/simclr_model.pth')  # Load SSL model weights
